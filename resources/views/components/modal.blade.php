...
<div x-data="{ on: false }">
    ...
    <div class="fixed z-50 inset-x-0 sm:inset-0 sm:flex sm:items-center sm:justify-center" x-show="on">
        ...
        <div class="bg-white dark:bg-gray-600 dark:text-gray-200 rounded-lg  shadow-xl transform transition-all {{ $height }}" role="dialog" aria-modal="true" aria-labelledby="modal-headline"
           x-show="on"
           x-transition:enter="ease-out duration-300"
